...
//
//  KEY CHANGE: All TMDB calls go to /api/tmdb/... on YOUR server.
//  The server (TmdbProxyController.java) adds the secret token.
//  No API key screen. No token in this file. Works for everyone.
// =============================================================
...
// ── TMDB proxy helper ──
// Calls your own server at /api/tmdb/...
// Server adds the secret token and forwards to TMDB.
